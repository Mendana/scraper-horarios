...
def run():
    ...
    with sync_playwright() as p:
        ...
        # Ir a la web
        url = "https://gobierno.ingenieriainformatica.uniovi.es/grado/plan/?y=24-25&t=s2"
        page.goto(url, wait_until="load")
        page.wait_for_selector('form[name="Seleccion"]')
        ...
        for i in range(0, total, chunk_size):
            ...
            filename = f"dataI/horario_s2_{i}-{min(i+chunk_size, total)-1}.csv"
